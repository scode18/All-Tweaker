...
'Очистка': ['Очистка от Igromanoff', 'Очистка рабочего стола', 'Очистка загрузок', 'Запуск меню очистки', 'Запуск очистки', 'Очистить Windows v2.0', 'Очистить Windows', 'Очистить автозапуск в реестре', 'Очистить временные файлы и кэш иконок', 'Очистить кэш', 'Очистка и оптимизация дисков', 'Очистка кэша обновлений', 'Очистка папок Temp', 'Очистка файла подкачки', 'Очистка хранилища WinSxS', 'Сбросить счетчик изображений', 'Удалить временные файлы от Adamx', 'Удалить временные файлы', 'Удалить кеш Центра обновления Windows', 'Удалить лог файлы', 'Удалить скачанные файлы обновлений Windows', 'Хардкор чистка 1', 'Хардкор чистка 2', 'Хардкор чистка 3'],
