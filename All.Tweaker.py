...
'Очистка': ['Запуск меню очистки', 'Запуск очистки', 'Очистить Windows v2.0', 'Очистить Windows', 'Очистить автозапуск в реестре', 'Очистить временные файлы и кэш иконок', 'Очистить кэш', 'Очистка и оптимизация дисков', 'Очистка кэша обновлений', 'Очистка папок Temp', 'Очистка файла подкачки', 'Очистка хранилища WinSxS', 'Сбросить счетчик изображений', 'Удалить временные файлы от Adamx', 'Удалить временные файлы', 'Удалить кеш Центра обновления Windows', 'Удалить лог файлы', 'Удалить скачанные файлы обновлений Windows', 'Хардкор чистка 1', 'Хардкор чистка 2', 'Хардкор чистка 3', 'Очистка диска C\\WinClean', 'Очистка диска C\\Включить гибернацию', 'Очистка диска C\\Включить зарезервированное хранилище', 'Очистка диска C\\Запуск меню очистки', 'Очистка диска C\\Запуск очистки', 'Очистка диска C\\Отключить гибернацию', 'Очистка диска C\\Отключить зарезервированное хранилище', 'Очистка диска C\\Отменить сжатие системы', 'Очистка диска C\\Очистка кэша обновлений', 'Очистка диска C\\Очистка папок Temp', 'Очистка диска C\\Очистка хранилища WinSxS', 'Очистка диска C\\Проверить сжатие системы', 'Очистка диска C\\Сжать систему', 'Очистка диска C\\Уменьшить размер файла гибернации'],
